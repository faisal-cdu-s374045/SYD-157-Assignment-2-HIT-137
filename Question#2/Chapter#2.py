def separate_and_convert(string):
    ...
    number_ascii = [
        ord(char) for char in number_str if char.isdigit() and int(char) % 2 == 0]
    letter_ascii = [ord(char) for char in letter_str]

    return number_str, letter_str, number_ascii, letter_ascii


passedString = "56OawIWi984kst#Z352a07Vm415ss785gfs31Dio"

number_str, letter_str, number_ascii, letter_ascii = separate_and_convert(
    passedString)
